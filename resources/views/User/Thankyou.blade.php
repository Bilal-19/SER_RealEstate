...
<div class="container-fluid mt-150 mt-sm-200">
    <div class="row">
        <div class="col-md-8 mx-auto style-container">
            <img src="{{ asset('assets/images/circle.webp') }}" alt="confirmation tick" class="img-fluid mt-5">
            ...
            <div class="d-flex justify-content-around align-items-center mt-5 bg-pale-gray p-3 rounded">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <img src="{{ asset("assets/images/phone.webp") }}" alt="whatsApp Icon" class="img-fluid icon">
                    </div>
                    <div class="mx-2">
                ...
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <img src="{{ asset("assets/images/email.webp") }}" alt="Email Icon" class="img-fluid icon">
                    </div>
                    <div class="mx-2">
