        ...
        <div class="col-md-8 mx-auto style-container">
            ...
            <div class="d-flex justify-content-around align-items-center mt-5 bg-pale-gray p-16">
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="mx-2">
                        <p class="mb-0 ff-inter fw-semibold">Phone</p>
                        <p class="mb-0 ff-inter fs-18">+44 7921919426</p>
                    </div>
                </div>
                ...
                <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div class="mx-2">
                        <p class="mb-0 ff-inter fw-semibold">Email</p>
                        <p class="mb-0 ff-inter fs-18">zain.rav@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
