    ...
    <div class="row mt-3">
        <div class="col-md-8 mx-auto">
            <form action="{{route("SubmitBookingEnquiry")}}" method="post" autocomplete="off">
                ...
                <div class="row d-flex justify-content-between mt-5">
                    <div class="col-md-5">
                        <input type="text" placeholder="Check In" name="check_in" class="form-control" onfocus="(this.type='date')">
                        <small class="text-danger">
                            @error('check_in')
                                {{ $message }}
                            @enderror
                    ...
                    <div class="col-md-5">
                        <input type="text" placeholder="Check Out" name="check_out" class="form-control" onfocus="(this.type='date')">
                        <small class="text-danger">
                            @error('check_out')
                                {{ $message }}
                            @enderror
